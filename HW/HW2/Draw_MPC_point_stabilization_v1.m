function Draw_MPC_point_stabilization_v1(t,xx,xx1,u_cl,xs,N,rob_diam,filename)
...
xlabel('time (seconds)')
ylabel('\omega (rad/s)')
title('Optimal control solution using single shooting')
grid on
close(myVideo)